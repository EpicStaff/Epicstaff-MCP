...
async def list_python_code(limit: int = 100, offset: int = 0) -> dict[str, Any]:
    ...
    async with get_client() as client:
        return await client.get(
            "/api/python-code/", params={"limit": limit, "offset": offset}
        )
...
async def run_python_code(
    ...
    python_code_id: ID of the Python code to run
    variables: optional dictionary of variables to pass to the entrypoint function
    """
    payload: dict[str, Any] = {"python_code_id": python_code_id}
...
async def list_python_code_results(
    ...
    Filterable by execution_id and/or returncode.
    """
