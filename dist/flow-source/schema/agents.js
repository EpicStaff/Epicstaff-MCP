 ...
 */
import { z } from 'zod';
import { entityRef, existingRefSchema, symbolicNameSchema, } from './common.js';
...
const defaultSurfaceEntrySchema = z
    .union([
    symbolicNameSchema.transform((name) => ({ surface: name, place: 'all' })),
    existingRefSchema.transform((ref) => ({ surface: ref, place: 'all' })),
    defaultSurfaceObjectSchema,
])
    .describe('A default surface assignment. Shorthand: a bare reference means {surface: <ref>, place: "all"}.');
